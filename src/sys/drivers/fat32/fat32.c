...
static void fat_printf_sector(const u8* sector);
...
static void fat_printf_info(struct info_s* info) {
	...
	printf_count(info->name, info->name_length);
	printf("\n");
}
